...
import { exchangeStravaCode, storeToken, fetchStravaActivities, convertStravaActivityToDataPoints } from '@/lib/api-clients';
        ...
        try {
          ...
          if (exerciseVariable) {
            ...
            activities.forEach((activity) => {
              const dataPoints = convertStravaActivityToDataPoints(activity);
          ...
          {status === 'success' && (
            <>
              ...
              <p className="text-gray-500 mb-4">
                Your Strava account has been connected. Redirecting to settings...
              </p>
            </>
          )}
